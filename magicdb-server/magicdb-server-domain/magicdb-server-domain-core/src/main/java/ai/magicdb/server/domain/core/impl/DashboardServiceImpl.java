...
import ai.magicdb.server.domain.api.model.Dashboard;
import ai.magicdb.server.domain.api.param.dashboard.DashboardCreateParam;
import ai.magicdb.server.domain.api.param.dashboard.DashboardPageQueryParam;
import ai.magicdb.server.domain.api.param.dashboard.DashboardQueryParam;
import ai.magicdb.server.domain.api.param.dashboard.DashboardUpdateParam;
import ai.magicdb.server.domain.api.service.DashboardService;
import ai.magicdb.server.domain.core.converter.DashboardConverter;
import ai.magicdb.server.domain.core.util.PermissionUtils;
import ai.magicdb.server.domain.repository.Dbutils;
import ai.magicdb.server.domain.repository.entity.DashboardChartRelationDO;
import ai.magicdb.server.domain.repository.entity.DashboardDO;
import ai.magicdb.server.domain.repository.mapper.DashboardChartRelationMapper;
import ai.magicdb.server.domain.repository.mapper.DashboardMapper;
import ai.magicdb.server.tools.base.enums.YesOrNoEnum;
...
import ai.magicdb.server.tools.common.exception.DataNotFoundException;
import ai.magicdb.server.tools.common.model.EasyLambdaQueryWrapper;
import ai.magicdb.server.tools.common.util.ContextUtils;
import ai.magicdb.server.tools.common.util.EasySqlUtils;
