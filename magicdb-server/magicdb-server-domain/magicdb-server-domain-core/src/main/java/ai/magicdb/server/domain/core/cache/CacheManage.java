package ai.magicdb.server.domain.core.cache;
...
public class CacheManage {
    private static final String PATH = System.getProperty("user.home") + File.separator + ".magicdb"
        + File.separator
        + "cache" + File.separator + "magicdb-ehcache-data_" +System.getProperty("spring.profiles.active");
