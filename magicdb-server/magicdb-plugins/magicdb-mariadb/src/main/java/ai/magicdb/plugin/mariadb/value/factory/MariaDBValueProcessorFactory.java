package ai.magicdb.plugin.mariadb.value.factory;

import ai.magicdb.plugin.mariadb.value.sub.MariaDBBitProcessor;
import ai.magicdb.plugin.mariadb.value.sub.MariaDBGeometryProcessor;
import ai.magicdb.plugin.mariadb.value.sub.MariaDBTimestampProcessor;
import ai.magicdb.plugin.mariadb.value.sub.MariaDBYearProcessor;
import ai.magicdb.plugin.mysql.type.MysqlColumnTypeEnum;
import ai.magicdb.plugin.mysql.value.sub.*;
