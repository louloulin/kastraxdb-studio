package ai.magicdb.plugin.postgresql.builder;

import ai.magicdb.plugin.postgresql.type.PostgreSQLColumnTypeEnum;
import ai.magicdb.plugin.postgresql.type.PostgreSQLIndexTypeEnum;
