...
import ai.magicdb.plugin.postgresql.builder.PostgreSQLSqlBuilder;
import ai.magicdb.plugin.postgresql.type.*;
...
import static ai.magicdb.plugin.postgresql.consts.SQLConst.DROP_TYPE_SQL;
import static ai.magicdb.plugin.postgresql.consts.SQLConst.TABLE_DEF_FUNCTION_SQL;
