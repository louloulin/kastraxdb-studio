...
import ai.magicdb.plugin.kingbase.builder.KingBaseSqlBuilder;
import ai.magicdb.plugin.kingbase.type.KingBaseColumnTypeEnum;
import ai.magicdb.plugin.kingbase.type.KingBaseDefaultValueEnum;
import ai.magicdb.plugin.kingbase.type.KingBaseIndexTypeEnum;
...
public class KingBaseMetaData extends DefaultMetaService implements MetaData {
    ...
    private String getDbVersion(){
        String version = MagicDBContext.getDbVersion();
