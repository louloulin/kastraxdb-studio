...
import ai.magicdb.plugin.db2.builder.DB2SqlBuilder;
import ai.magicdb.plugin.db2.constant.SQLConstant;
import ai.magicdb.plugin.db2.type.DB2ColumnTypeEnum;
import ai.magicdb.plugin.db2.type.DB2DefaultValueEnum;
import ai.magicdb.plugin.db2.type.DB2IndexTypeEnum;
