...
import ai.magicdb.plugin.dm.builder.DMSqlBuilder;
import ai.magicdb.plugin.dm.type.DMColumnTypeEnum;
import ai.magicdb.plugin.dm.type.DMDefaultValueEnum;
import ai.magicdb.plugin.dm.type.DMIndexTypeEnum;
