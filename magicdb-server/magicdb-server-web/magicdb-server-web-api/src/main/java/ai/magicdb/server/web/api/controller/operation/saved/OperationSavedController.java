package ai.magicdb.server.web.api.controller.operation.saved;

import java.util.List;

import ai.magicdb.server.domain.api.model.Operation;
import ai.magicdb.server.domain.api.param.operation.OperationPageQueryParam;
import ai.magicdb.server.domain.api.param.operation.OperationQueryParam;
import ai.magicdb.server.domain.api.param.operation.OperationSavedParam;
import ai.magicdb.server.domain.api.param.operation.OperationUpdateParam;
import ai.magicdb.server.domain.api.service.OperationService;
...
import ai.magicdb.server.web.api.controller.operation.saved.converter.OperationWebConverter;
import ai.magicdb.server.web.api.controller.operation.saved.request.BatchTabCloseRequest;
import ai.magicdb.server.web.api.controller.operation.saved.request.OperationCreateRequest;
import ai.magicdb.server.web.api.controller.operation.saved.request.OperationQueryRequest;
import ai.magicdb.server.web.api.controller.operation.saved.request.OperationUpdateRequest;
import ai.magicdb.server.web.api.controller.operation.saved.vo.OperationVO;
