...
import ai.magicdb.server.domain.api.param.GroupByParam;
import ai.magicdb.server.domain.api.param.OrderByParam;
import ai.magicdb.server.domain.api.param.UpdateSelectResultParam;
...
import ai.magicdb.server.web.api.http.request.SqlExecuteHistoryCreateRequest;
