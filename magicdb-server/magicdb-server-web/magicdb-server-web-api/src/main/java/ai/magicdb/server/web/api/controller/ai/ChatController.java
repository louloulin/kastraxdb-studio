...
import ai.magicdb.server.domain.api.param.ShowCreateTableParam;
import ai.magicdb.server.domain.api.param.TableQueryParam;
...
import ai.magicdb.server.tools.base.enums.WhiteListTypeEnum;
...
import ai.magicdb.server.web.api.controller.ai.azure.client.AzureOpenAIClient;
import ai.magicdb.server.web.api.controller.ai.azure.listener.AzureOpenAIEventSourceListener;
import ai.magicdb.server.web.api.controller.ai.azure.model.AzureChatMessage;
import ai.magicdb.server.web.api.controller.ai.azure.model.AzureChatRole;
import ai.magicdb.server.web.api.controller.ai.baichuan.client.BaichuanAIClient;
import ai.magicdb.server.web.api.controller.ai.baichuan.listener.BaichuanChatAIEventSourceListener;
import ai.magicdb.server.web.api.controller.ai.magicdb.client.MagicdbAIClient;
import ai.magicdb.server.web.api.controller.ai.magicdb.listener.MagicdbAIEventSourceListener;
import ai.magicdb.server.web.api.controller.ai.claude.client.ClaudeAIClient;
import ai.magicdb.server.web.api.controller.ai.claude.listener.ClaudeAIEventSourceListener;
import ai.magicdb.server.web.api.controller.ai.claude.model.ClaudeChatCompletionsOptions;
import ai.magicdb.server.web.api.controller.ai.claude.model.ClaudeChatMessage;
import ai.magicdb.server.web.api.controller.ai.config.LocalCache;
import ai.magicdb.server.web.api.controller.ai.converter.ChatConverter;
import lombok.extern.slf4j.Slf4j;
import ai.magicdb.server.web.api.controller.ai.enums.PromptType;
import ai.magicdb.server.web.api.controller.ai.fastchat.client.FastChatAIClient;
import ai.magicdb.server.web.api.controller.ai.fastchat.embeddings.FastChatEmbeddingResponse;
import ai.magicdb.server.web.api.controller.ai.fastchat.listener.FastChatAIEventSourceListener;
import ai.magicdb.server.web.api.controller.ai.fastchat.model.FastChatMessage;
import ai.magicdb.server.web.api.controller.ai.fastchat.model.FastChatRole;
import ai.magicdb.server.web.api.controller.ai.openai.client.OpenAIClient;
import ai.magicdb.server.web.api.controller.ai.openai.listener.OpenAIEventSourceListener;
import ai.magicdb.server.web.api.controller.ai.request.ChatQueryRequest;
import ai.magicdb.server.web.api.controller.ai.request.ChatRequest;
import ai.magicdb.server.web.api.controller.ai.rest.client.RestAIClient;
import ai.magicdb.server.web.api.controller.ai.rest.listener.RestAIEventSourceListener;
import ai.magicdb.server.web.api.controller.ai.tongyi.client.TongyiChatAIClient;
import ai.magicdb.server.web.api.controller.ai.tongyi.listener.TongyiChatAIEventSourceListener;
import ai.magicdb.server.web.api.controller.ai.wenxin.client.WenxinAIClient;
import ai.magicdb.server.web.api.controller.ai.wenxin.listener.WenxinAIEventSourceListener;
import ai.magicdb.server.web.api.controller.ai.zhipu.client.ZhipuChatAIClient;
import ai.magicdb.server.web.api.controller.ai.zhipu.listener.ZhipuChatAIEventSourceListener;
...
import ai.magicdb.server.web.api.http.request.EsTableSchemaRequest;
import ai.magicdb.server.web.api.http.request.TableSchemaRequest;
import ai.magicdb.server.web.api.http.request.WhiteListRequest;
import ai.magicdb.server.web.api.http.response.EsTableSchemaResponse;
import ai.magicdb.server.web.api.http.response.TableSchemaResponse;
...
public class ChatController {
    ...
    public SseEmitter distributeAISql(ChatQueryRequest queryRequest, SseEmitter sseEmitter, String uid) throws IOException {
        ...
        String aiSqlSource = AiSqlSourceEnum.MAGICDBAI.getCode();
        ...
        switch (Objects.requireNonNull(aiSqlSourceEnum)) {
            ...
            case MAGICDBAI:
                return chatWithMagicdbAi(queryRequest, sseEmitter, uid);
            case RESTAI :
     ...
     * @throws IOException
     */
    private SseEmitter chatWithMagicdbAi(ChatQueryRequest queryRequest, SseEmitter sseEmitter, String uid)
        throws IOException {
        String prompt = buildPrompt(queryRequest);
        if (prompt.length() / TOKEN_CONVERT_CHAR_LENGTH > MAX_PROMPT_LENGTH) {
        ...
        MagicdbAIEventSourceListener openAIEventSourceListener = new MagicdbAIEventSourceListener(sseEmitter);
        MagicdbAIClient.getInstance().streamCompletions(messages, openAIEventSourceListener);
        LocalCache.CACHE.put(uid, JSONUtil.toJsonStr(messages), LocalCache.TIMEOUT);
        return sseEmitter;
    }
...
//                properties = queryDatabaseSchema(queryRequest) + querySchemaByEs(queryRequest);
    ...
    public FastChatEmbeddingResponse distributeAIEmbedding(String input) {
        ...
        switch (Objects.requireNonNull(aiSqlSourceEnum)) {
            case MAGICDBAI:
                return embeddingWithMagicdbAi(input);
            case FASTCHATAI:
     ...
     * @return
     */
    private FastChatEmbeddingResponse embeddingWithMagicdbAi(String input) {
        FastChatEmbeddingResponse embeddings = MagicdbAIClient.getInstance().embeddings(input);
        return embeddings;
    }
