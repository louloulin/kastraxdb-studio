...
import ai.magicdb.server.web.api.controller.ai.magicdb.interceptor.MagicdbHeaderAuthorizationInterceptor;
import ai.magicdb.server.web.api.controller.ai.fastchat.client.FastChatOpenAiApi;
import ai.magicdb.server.web.api.controller.ai.fastchat.embeddings.FastChatEmbedding;
 ...
 */
@Slf4j
public class MagicDBAIStreamClient {
     ...
     * @param builder
     */
    private MagicDBAIStreamClient(Builder builder) {
    ...
    private OkHttpClient okHttpClient() {
        OkHttpClient okHttpClient = new OkHttpClient
            .Builder()
            .addInterceptor(new MagicdbHeaderAuthorizationInterceptor(this.apiKey, this.model))
     ...
     * @return
     */
    public static MagicDBAIStreamClient.Builder builder() {
        return new MagicDBAIStreamClient.Builder();
    }
    ...
    public static final class Builder {
        ...
        public MagicDBAIStreamClient.Builder apiKey(String apiKeyValue) {
         ...
         * @return
         */
        public MagicDBAIStreamClient.Builder apiHost(String apiHostValue) {
         ...
         * @return
         */
        public MagicDBAIStreamClient.Builder model(String modelValue) {
            this.model = modelValue;
            return this;
        }

        public MagicDBAIStreamClient.Builder embeddingModel(String embeddingModelValue) {
            this.embeddingModel = embeddingModelValue;
            return this;
        }

        public MagicDBAIStreamClient.Builder okHttpClient(OkHttpClient val) {
            this.okHttpClient = val;
            return this;
        }

        public MagicDBAIStreamClient build() {
            return new MagicDBAIStreamClient(this);
        }
