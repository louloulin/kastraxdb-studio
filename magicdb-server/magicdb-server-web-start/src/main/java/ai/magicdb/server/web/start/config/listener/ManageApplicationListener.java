package ai.magicdb.server.web.start.config.listener;//package ai.magicdb.server.start.config.listener;
//
//import com.alibaba.fastjson2.JSON;
//import com.alibaba.fastjson2.TypeReference;
//
//import ai.magicdb.server.tools.base.enums.SystemEnvironmentEnum;
...
//                    if (StringUtils.equals("magicdb-server-start.jar", argument)) {
//                        isDbhub = true;
//                    }
