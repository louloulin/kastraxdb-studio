package ai.magicdb.data.service.core.integration
...
import ai.magicdb.data.service.core.cache.DataServiceCacheManager
import ai.magicdb.data.service.core.executor.DefaultDataServiceExecutor
import ai.magicdb.data.service.core.manager.DefaultDataServiceManager
import ai.magicdb.data.service.core.repository.MemoryDataServiceRepository
...
class DataServiceIntegrationTest {
    ...
    fun setUp() {
        ...
        val cachedResult = ServiceResult(
            success = true,
            data = mapOf("result" to 30),
            fromCache = true,
            cacheKey = "service:test:123",
