package ai.magicdb.server.start.exception;

import java.util.Map;

import com.alibaba.fastjson2.JSON;

import ai.magicdb.server.start.exception.convertor.BindExceptionConvertor;
import ai.magicdb.server.start.exception.convertor.BusinessExceptionConvertor;
import ai.magicdb.server.start.exception.convertor.DefaultExceptionConvertor;
import ai.magicdb.server.start.exception.convertor.ExceptionConvertor;
import ai.magicdb.server.start.exception.convertor.MaxUploadSizeExceededExceptionConvertor;
import ai.magicdb.server.start.exception.convertor.MethodArgumentNotValidExceptionConvertor;
import ai.magicdb.server.start.exception.convertor.MethodArgumentTypeMismatchExceptionConvertor;
import ai.magicdb.server.start.exception.convertor.ParamExceptionConvertor;
import ai.magicdb.server.tools.base.excption.BusinessException;
import ai.magicdb.server.tools.base.excption.SystemException;
import ai.magicdb.server.tools.base.wrapper.result.ActionResult;
import ai.magicdb.server.tools.common.exception.NeedLoggedInBusinessException;
