package ai.magicdb.server.start.test.mybatis;
...
import ai.magicdb.server.start.test.common.BaseTest;
...
public class MybatisGeneratorTest extends BaseTest {
    ...
    public void coreGenerator() {
        ...
        if ("dev".equalsIgnoreCase(environment)) {
            dataSource.setJdbcUrl("jdbc:h2:file:~/.magicdb/db/magicdb_dev;MODE=MYSQL");
        }else if ("test".equalsIgnoreCase(environment)) {
            dataSource.setJdbcUrl("jdbc:h2:file:~/.magicdb/db/magicdb_test;MODE=MYSQL");
        }else {
            dataSource.setJdbcUrl("jdbc:h2:~/.magicdb/db/magicdb;MODE=MYSQL;FILE_LOCK=NO");
        }
    ...
    private void doGenerator(List<String> tableList) {
        ...
        // The current project address is the magicdb-server-start address.
        String outputDir = System.getProperty("user.dir")
            + "/../magicdb-server-domain/magicdb-server-domain-repository/src/main"
            + "/java";
        ...
        FastAutoGenerator
            ...
            .packageConfig(builder -> {
                ...
                builder.parent("ai.magicdb.server.domain.repository")
