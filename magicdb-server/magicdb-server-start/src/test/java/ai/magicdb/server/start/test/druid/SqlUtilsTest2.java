package ai.magicdb.server.start.test.druid;
...
public class SqlUtilsTest2 {
    ...
    @Test
    public void insert() {
        SQLStatement sqlStatement = SQLUtils.parseSingleStatement("INSERT INTO magicdb.`order` (id, user_id, total_price, created_at, updated_at) VALUES (8, 345, 5601.16, '2022-09-18 11:21:12', '2023-04-30 11:21:12');",
            DbType.mysql);
