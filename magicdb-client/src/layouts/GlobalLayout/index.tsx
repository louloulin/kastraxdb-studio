      ...
      <div className={styles.app}>
        <div className={styles.loadingBox}>
          ...
          <div className={styles.contact}>
            ...
            <GithubOutlined className={styles.icon} onClick={() => window.open('https://github.com/magicdb/MagicDB')} />
            <Tooltip
              placement="bottom"
              title={<img style={{ width: 200, height: 200 }} src="https://sqlgpt.cn/_static/img/magicdb_wechat.png" />}
            >
