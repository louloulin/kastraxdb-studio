export default {
  ...
  'login.text.welcome': 'MagicDB\'ye Hoş Geldiniz',
  'login.text.tips': 'MagicDB hesabı yalnızca takım işbirliği yönetimi içindir.',
  ...
  'login.tips.defaultPassword': 'Varsayılan kullanıcı adı ve şifre: magicdb',
};
