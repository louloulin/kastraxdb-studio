export default {
  ...
  'setting.placeholder.magicdbApiKey': "MagicDB tarafından sağlanan APIKEY'i kullanın",
  ...
  'setting.magicdb.ai.button': `Daha güçlü AI özellikleri için lütfen MagicDB Pro'yu ziyaret edin`,
  'setting.title.goto.magicdb.pro': `MagicDB Pro'ya Git`,
};
