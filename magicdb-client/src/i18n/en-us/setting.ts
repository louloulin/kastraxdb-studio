export default {
  ...
  'setting.placeholder.magicdbApiKey': 'Use the APIKEY provided by MagicDB',
  ...
  'setting.magicdb.ai.button': 'Please visit MagicDB Pro for more powerful AI features',
  'setting.title.goto.magicdb.pro': 'Go to MagicDB Pro',
};
