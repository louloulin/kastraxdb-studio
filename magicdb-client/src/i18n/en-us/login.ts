export default {
  ...
  'login.text.welcome': 'Welcome to MagicDB',
  'login.text.tips': 'The MagicDB account is only for team collaboration management.',
  ...
  'login.tips.defaultPassword': 'The default user name and password are: magicdb',
};
