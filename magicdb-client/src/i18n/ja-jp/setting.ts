export default {
  ...
  'setting.placeholder.magicdbApiKey': 'MagicDBが提供するAPIキーを使用します',
  ...
  'setting.magicdb.ai.button': 'より強力なAI機能を体験するために、MagicDB Proをご利用ください',
  'setting.title.goto.magicdb.pro': 'MagicDB Proへ行く',
};
